...
Uses a custom [pruning module](https://www.npmjs.com/package/pruner) to remove all of the packages
specified in the `devDependencies` section of `package.json` from the outputted Electron app.
