...
[Usage](#usage) |
[API](https://electron.github.com/electron-packager/master/) |
...
JavaScript API usage can be found in the [API documentation](https://electron.github.com/electron-packager/master/modules/electronpackager.html).
...
detailed descriptions, see the [API documentation](https://electron.github.com/electron-packager/master/modules/electronpackager.html).
